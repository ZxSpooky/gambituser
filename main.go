...
import (
	...
	"errors"
	"fmt"
	"os" //necesario para variables de entorno

	"github.com/ZxSpooky/gambituser/awsgo"
	"github.com/ZxSpooky/gambituser/bd"
...
func ValidoParametros() bool { //funcion que valida que el secret name llega a la variable de entorno
